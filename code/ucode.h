...
/* 70 */Y( 0,  0x09 , _LHU_2             )
/* 71 */Y( 0,  0x09 , _aFaultc           )
/* 72 */Y( 0,     0 , _LBU_3             )
/* 73 */Y( 0,     0 , _BAERR_1           )
/* 74 */Y( 0,  0x0a , _BrOpFet           )
/* 75 */Y( 0,  0x0a , _BAlignEr          )
/* 76 */Y( 0,     0 , _BAERR_2           )
/* 77 */Y( 0,     0 , _BAERR_3           )
...
/* a4 */Y( 1,     0 , _SRxI_0            )
/* a5 */Y( 1,     0 , _MRET_3            )
/* a6 */Y( 0,  0x0e , _ECAL_RET          )
/* a7 */Y( 0,  0x0e , _EBRKWFI1          )
...
/* cf */Y( 0,     0 , _MRET_7            )
/* d0 */Y( 0,  0x10 , _ECALL_1           )
/* d1 */Y( 0,  0x10 , _MRET_1            )
/* d2 */Y( 0,  0x11 , _LB_2              )
/* d3 */Y( 0,  0x11 , _aFaultd           )
/* d4 */Y( 0,     0 , _aFault_2          )
/* d5 */Y( 0,     0 , _eFetch2           )
/* d6 */Y( 0,     0 , _jFault_1          )
/* d7 */Y( 0,     0 , _LH_3              )
...
/* e6 */Y( 0,  0x13 , _StdIncPc          )
/* e7 */Y( 0,  0x13 , _aFault            )
/* e8 */Y( 1,     0 , _ILL_0(_Le8)       )
/* e9 */Y( 0,     0 , _aF_SW_3           )
/* ea */Y( 1,  0x14 , _ILL_0(_Lea)       )
/* eb */Y( 0,  0x14 , _ECALL_3           )
/* ec */Y( 1,     0 , _AND_0             )
/* ed */Y( 0,     0 , _Led,"q:ed", unx   )
/* ee */Y( 1,     0 , _ILL_0(_Lee)       )
/* ef */Y( 0,     0 , _Lef,"q:ef", unx   )
/* f0 */Y( 0,  0x15 , _LBU_2             )
/* f1 */Y( 0,  0x15 , _aFaulte           )
/* f2 */Y( 0,  0x16 , _SW_2              )
/* f3 */Y( 0,  0x16 , _aF_SW             ) 
/* f4 */Y( 0,     0 , _Fetch2            )
/* f5 */Y( 0,     0 , _jFault            )
/* f6 */Y( 0,  0x17 , _WFI_1             )
/* f7 */Y( 0,  0x17 , _EBREAK_1          ) 
/* f8 */Y( 1,     0 , _BGEU              )
