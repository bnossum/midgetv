...
r( 'Q', 0000, 0000, 0000,     00000, 001,   00000,       0001111, fence_i ) /* 38 */
...
E( 'E', 0001000,       00101, 00000, 000,   00000,       1110011, wfi     ) /* 44 */
C( 'C', csr,                  rs1,   001,   rd,          1110011, csrrw   ) /* 45 */
C( 'C', csr,                  rs1,   010,   rd,          1110011, csrrs   ) /* 46 */
C( 'C', csr,                  rs1,   011,   rd,          1110011, csrrc   ) /* 47 */
C( 'C', csr,                  zimm,  101,   rd,          1110011, csrrwi  ) /* 48 */
C( 'C', csr,                  zimm,  110,   rd,          1110011, csrrsi  ) /* 49 */
C( 'C', csr,                  zimm,  111,   rd,          1110011, csrrci  ) /* 50 */
#undef R                                                                  
#undef r                                                                  
#undef I                                                                  
#undef S
