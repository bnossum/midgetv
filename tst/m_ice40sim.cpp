...
//old   d |= (tb->v->inst_ice40sim_EBRonly->inst_midgetv_core->inst_sram->genblk2__DOT__blk0__BRA__0__KET____DOT__blk1__BRA__1__KET____DOT__sram->get_as_16(wa) <<16 );
        ...
        d |= (tb->v->inst_ice40sim_EBRonly->inst_midgetv_core->inst_ram->genblk2__DOT__blk0__BRA__0__KET____DOT__blk1__BRA__1__KET____DOT__sram->get_as_16(wa) <<16 );
...
//old                tb->v->inst_ice40sim_EBRonly->inst_midgetv_core->inst_sram->genblk2__DOT__blk0__BRA__0__KET____DOT__blk1__BRA__0__KET____DOT__sram->set_as_16(k>>2,h);
                tb->v->inst_ice40sim_EBRonly->inst_midgetv_core->inst_ram->genblk2__DOT__blk0__BRA__0__KET____DOT__blk1__BRA__0__KET____DOT__sram->set_as_16(k>>2,h);
                h = (ebr[j+3]<<8) | ebr[j+2];
                //if ( j == 1024 ) printf( "Highhalf= 0x%4.4x\n", h );
//old                tb->v->inst_ice40sim_EBRonly->inst_midgetv_core->inst_sram->genblk2__DOT__blk0__BRA__0__KET____DOT__blk1__BRA__1__KET____DOT__sram->set_as_16(k>>2,h);
                tb->v->inst_ice40sim_EBRonly->inst_midgetv_core->inst_ram->genblk2__DOT__blk0__BRA__0__KET____DOT__blk1__BRA__1__KET____DOT__sram->set_as_16(k>>2,h);
        }
