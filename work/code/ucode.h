...
#define _jFault_1 jFault_1,"       Store 1 to mcause",                                  0,-1,            isr_none     | A_add1    | Wmcaus| Rjj       | Qx   | sr_h  | u_cont         | n(LDAF_3)
...
//                                                                                      Fixed/even       ISR          | ALU         Write   intern      Reg    Shreg   Ucode            Next
//                                                                                      | Pair           action       | op          adr/en  read adr    op     op      operation        ucode
#define _i0StdIncPc StdIncPc," Fr00  IncPC, OpFetch",                                   2,-1,            nxtSTB       | A_add4    | Wjj   | Ralu      | Qeu  | sr_h  | u_cont         | n(Fetch  )   // [1] Must be at even ucode adr. Goes to either Fetch or eFetch. 
#define _i0Fetch    Fetch ,  " Fr00  Read and latch instruction",                       2,-1,            isr_none     | A_passq   | Wpc   | rttime    | Qz   | sr_h  | u_io_i_latch   | n(Fetch2 )   // [3] Must be at even ucode adr. Fetch from EBR. Next go to Fetch2 or jFault
...
#define _LDAF_3   LDAF_3,  "       PC to mepc",                                     0,-1,            isr_none     | A_passd   | Wmepc | rmtvec    | Qx   | sr_h  | u_cont         | n(JAL_4)
//
...
#define _x_condb_4  condb_4, "       Branch on condition",                          0,-1,            isr_none     | A_passd   | Wjj   | Ryy       | Qu   | sr_h  | usebcond       | n(condb_5 )  
...
//                                                                                  Fixed/even       ISR          | ALU         Write   intern      Reg    Shreg   Ucode            Next
//                                                                                  | Pair           action       | op          adr/en  read adr    op     op      operation        ucode
#define _ixBrOpFet  BrOpFet ,"NewOp2 Read until instruction latched",               2,-1,            isr_none     | A_passq   | Wnn   | rHorTtime | Qcndz| sr_h  | u_io_i_latch   | n(Fetch2  )  /* Must be placed at even ucode adr     */ 
...
#define _ixBAERR_4  BAERR_4, "       Store 0 to mcause. Prep get trap entry pont",  0,-1,            isr_intoTrap | A_passd   | Wmcaus| rmtvec    | Qx   | sr_h  | u_cont         | n(JAL_4)   
...
#define _x_JAL_1    JAL_1,   "       Target adr to yy",                             2,-1,            isr_none     | A_addDQ   | Wyy   | Rpc       | Qz   | sr_h  | u_cont         | n(JAL_2)   /* Must be at even ucodeadr. Goes to either _x_JAL_2 or _x_JALRE1 */  
#define _x_JAL_2    JAL_2,   "       Return address to TRG",                        2,-1,            isr_none     | A_add2or4 | WTRG  | Rpc       | Qx   | sr_h  | u_cont         | n(JAL_3)   /* [qq] JAL_2 must be at even ucodeadr */
#define _JAL_3      JAL_3,   "       Instr. adr. to jj in case of access error",    0,-1,            isr_none     | A_passd   | Wjj   | Ryy       | Qx   | sr_h  | u_cont         | n(JAL_4)   /* */
#define _JAL_4      JAL_4,   "       PC+imm/trap entrypt to PC. OpFetch",           0,-1,            nxtSTB       | A_passd   | Wpc   | Ralu      | Qeu  | sr_h  | u_cont         | n(Fetch)   /* Goes to either Fetch or eFetch */
...
#define _r_JAL_2    JAL_2,   "       Return address to TRG",                        0,-1,            isr_none     | A_add2or4 | WTRG  | Rpc       | Qz   | sr_h  | u_cont         | n(JAL_3)   /* [qq] JAL_2 must be at even ucodeadr */
...
//
#define _JALR_0     JALR_0,  "JALR   jj=RS1+imm",                                   1,0x19,          isr_none     | A_addDQ   | Wyy   | r00000000 | Qz   | sr_h  | u_cont         | n(JALR_1)    
#define _JALR_1     JALR_1,  "       Q=1",                                          0,-1,            isr_none     | A_add1    | Wnn   | Ryy       | Qu   | sr_h  | u_cont         | n(JALR_2)    
...
#define _SW_E4    SW_E4,   "       Store 6 to mcause",                              0,-1,            isr_intoTrap | A_shlq    | Wmcaus| rmtvec    | Qx   | sr_h  | u_cont         | n(JAL_4)     // A comment I don't recall require this to be at an even ucodeadr see [what!]. Is it because we go into trap?
//                                                                                                                                                               
...
#define _ILL_4    ILL_4,   "       Store 2 to mcause",                              0,-1,            isr_intoTrap | A_add1    | Wmcaus| rmtvec    | Qx   | sr_h  | u_cont         | n(JAL_4) 
//                                                                                                                                                               
...
#define _ECALL_6  ECALL_6, "       mcause = 11",                                    0,-1,            isr_intoTrap | A_add3w   | Wmcaus| rmtvec    | Qx   | sr_h  | u_cont         | n(JAL_4)   // A comment I don't recall say this must be at even adr [what2]
...
#define _CSRRW_1  CSRRW_1, "       Construct PC storage adr",                       0,-1,            isr_none     | A_add1    | Wnn   | Rpc       | Qu   | sr_h  | u_cont         | n(CSRRW_2)
...
#define _CSRRW_4  CSRRW_4, "       IncPC, OpFetch, but force +4",                   0,-1,            nxtSTB       | A_add4    | Wjj   | Ralu      | Qeu  | sr_h  | u_cont         | n(Fetch)     // Cleanup once verified
//                                                                                                                                                               
...
#define _x_IJ_4   IJ_4,    "       Mask and use as PC",                             0,-1,            nxtSTB       | A_nearAND | Wnn   | Ralu      | Qeu  | sr_h  | u_cont         | n(Fetch)    /* Goes to either Fetch or eFetch */
...
#define _NMI_2    NMI_2,   "       mtval = 0.",                                     0,-1,            isr_intoTrap | A_passq   | Wmtval| NMIorInInt| Qz   | sr_h  | u_cont         | n(JAL_4) 
...
/* 13 */Y(0,   0, _JAL_4                                                                                                                                                                                                        , 0, 0xffffffff, 0x00000000, 0          ) //
...
/* 16 */Y(0,0x04, Z(_x_condb_5      ,_x_condb_5      ,_x_condb_5      ,_x_condb_5      ,_x_condb_5      ,_x_condb_5      ,_r_condb_5      ,_r_condb_5      ,_r_condb_5      ,_r_condb_5      ,_r_condb_5      ,_r_condb_5      ), 0, 0xffffffff, 0x00000000, 0          ) //                         
/* 17 */Y(0,0x04, Z(_x_condb_5t     ,_x_condb_5t     ,_x_condb_5t     ,_x_condb_5t     ,_x_condb_5t     ,_x_condb_5t     ,_r_condb_5t     ,_r_condb_5t     ,_r_condb_5t     ,_r_condb_5t     ,_r_condb_5t     ,_r_condb_5t     ), 0, 0xffffffff, 0x00000000, 0          ) //                         
...
/* 32 */Y(0,0x06, Z(_x_JAL_1        ,_x_JAL_1        ,_x_JAL_1        ,_x_JAL_1        ,_x_JAL_1        ,_x_JAL_1        ,_r_JAL_1        ,_r_JAL_1        ,_r_JAL_1        ,_r_JAL_1        ,_r_JAL_1        ,_r_JAL_1        ), 0, 0xffffffff, 0x00000000, 0          ) //                         
/* 33 */Y(0,0x06, Z(_x_JAERR_1      ,_x_JAERR_1      ,_x_JAERR_1      ,_x_JAERR_1      ,_x_JAERR_1      ,_x_JAERR_1      ,_unx33          ,_unx33          ,_unx33          ,_unx33          ,_unx33          ,_unx33          ), 0, 0xffffffff, 0x00000000, 0          ) //
...
/* 42 */Y(0,0x08, Z(_unx42          ,_unx42          ,_unx42          ,_MULHU_2        ,_MULHU_2        ,_MULHU_2        ,_unx42          ,_unx42          ,_unx42          ,_MULHU_2        ,_MULHU_2        ,_MULHU_2        ), 2, 0x00400000, 0x00000000, 0          ) // illegal as entry. Can get here from OpCode close to "ij"
/* 43 */Y(0,0x08, Z(_unx43          ,_unx43          ,_unx43          ,_MULHU_4        ,_MULHU_4        ,_MULHU_4        ,_unx43          ,_unx43          ,_unx43          ,_MULHU_4        ,_MULHU_4        ,_MULHU_4        ), 2, 0x00400000, 0x00000000, 0          ) // illegal as entry. Can get here from OpCode close to FENCE
...
/* 4e */Y(0,0x0a, _eILL0b                                                                                                                                                                                                       , 0, 0xffffffff, 0x00000000, 0          ) // Reached with LAZY_DECODE==1 but forward progress ensured || Wants to relocate these
/* 4f */Y(0,0x0a, _MRET_8                                                                                                                                                                                                       , 0, 0xffffffff, 0x00000000, 0          ) // Reached with LAZY_DECODE==1. Will work as a strange JMP  || Wants to relocate these
/* 50 */Y(0,0x0c, _LW_1                                                                                                                                                                                                         , 0, 0xffffffff, 0x00000000, 0          ) //
/* 51 */Y(0,0x0c, _LDAF_LW                                                                                                                                                                                                      , 0, 0xffffffff, 0x00000000, 0          ) //
/* 52 */Y(0,0x0e, _LH_1                                                                                                                                                                                                         , 0, 0xffffffff, 0x00000000, 0          ) //
/* 53 */Y(0,0x0e, _LDAF_LH                                                                                                                                                                                                      , 0, 0xffffffff, 0x00000000, 0          ) //
/* 54 */Y(0,0x10, _LH_2                                                                                                                                                                                                         , 0, 0xffffffff, 0x00000000, 0          ) //
/* 55 */Y(0,0x10, _aFaultb                                                                                                                                                                                                      , 0, 0xffffffff, 0x00000000, 0          ) //
/* 56 */Y(0,   0, _LH_4                                                                                                                                                                                                         , 0, 0xffffffff, 0x00000000, 0          ) //
/* 57 */Y(0,   0, _LH_5                                                                                                                                                                                                         , 0, 0xffffffff, 0x00000000, 0          ) //
/* 58 */Y(0,0x12, Z(_unx58          ,_unx58          ,_unx58          ,_DIV_A          ,_DIV_A          ,_DIV_A          ,_unx58          ,_unx58          ,_unx58          ,_DIV_A          ,_DIV_A          ,_DIV_A          ), 2, 0x00400000, 0x00000000, 0          ) // illegal as entry. Can get here from OpCode close to "BEQ"
/* 59 */Y(0,0x12, Z(_unx59          ,_unx59          ,_unx59          ,_DIV_B          ,_DIV_B          ,_DIV_B          ,_unx59          ,_unx59          ,_unx59          ,_DIV_B          ,_DIV_B          ,_DIV_B          ), 2, 0x00400000, 0x00000000, 0          ) // illegal as entry. Can get here from OpCode close to "JALR"
...
/* 5e */Y(0,0x14, _LHU_1                                                                                                                                                                                                        , 0, 0xffffffff, 0x00000000, 0          ) //
/* 5f */Y(0,0x14, _LDAF_LHU                                                                                                                                                                                                     , 0, 0xffffffff, 0x00000000, 0          ) //
...
/* 62 */Y(0,0x16, Z(_unx62          ,_unx62          ,_unx62          ,_DIV_8          ,_DIV_8          ,_DIV_8          ,_unx62          ,_unx62          ,_unx62          ,_DIV_8          ,_DIV_8          ,_DIV_8          ), 2, 0x00400000, 0x00000000, 0          ) // illegal as entry. Can get here from OpCode close to "ij"
/* 63 */Y(0,0x16, Z(_unx63          ,_unx63          ,_unx63          ,_DIV_9          ,_DIV_9          ,_DIV_9          ,_unx63          ,_unx63          ,_unx63          ,_DIV_9          ,_DIV_9          ,_DIV_9          ), 2, 0x00400000, 0x00000000, 0          ) // illegal as entry. Can get here from OpCode close to FENCE
/* 64 */Y(1,   0, _SLTIU_0                                                                                                                                                                                                      , 1, 0x0000707f, 0x00003013, (1<<22)    ) // SLTIU
/* 65 */Y(0,   0, _WFI_4                                                                                                                                                                                                        , 0, 0xffffffff, 0x00000000, 0          ) //
/* 66 */Y(0,0x18, _SW_1                                                                                                                                                                                                         , 0, 0xffffffff, 0x00000000, 0          ) //
/* 67 */Y(0,0x18, _SW_E1SWE                                                                                                                                                                                                     , 0, 0xffffffff, 0x00000000, 0          ) //
/* 68 */Y(0,0x1a, Z(_unx68          ,_unx68          ,_unx68          ,_DIV_12         ,_DIV_12         ,_DIV_12         ,_unx68          ,_unx68          ,_unx68          ,_DIV_12         ,_DIV_12         ,_DIV_12         ), 2, 0x00200000, 0x00000000, 0          ) // illegal as entry. Can get here from OpCode close to "SW"
/* 69 */Y(0,0x1a, Z(_unx69          ,_unx69          ,_unx69          ,_DIV_13         ,_DIV_13         ,_DIV_13         ,_unx69          ,_unx69          ,_unx69          ,_DIV_13         ,_DIV_13         ,_DIV_13         ), 0, 0xffffffff, 0x00000000, 0          ) //                                                         
...
/* 70 */Y(0,0x1c, _LHU_2                                                                                                                                                                                                        , 0, 0xffffffff, 0x00000000, 0          ) //
/* 71 */Y(0,0x1c, _aFaultc                                                                                                                                                                                                      , 0, 0xffffffff, 0x00000000, 0          ) //
...
/* 74 */Y(0,0x1e, Z(_ixBrOpFet      ,_ixBrOpFet      ,_ixBrOpFet      ,_ixBrOpFet      ,_ixBrOpFet      ,_ixBrOpFet      ,_unx74          ,_unx74          ,_unx74          ,_unx74          ,_unx74          ,_unx74          ), 0, 0xffffffff, 0x00000000, 0          ) //
/* 75 */Y(0,0x1e, Z(_ixBAlignEr     ,_ixBAlignEr     ,_ixBAlignEr     ,_ixBAlignEr     ,_ixBAlignEr     ,_ixBAlignEr     ,_unx75          ,_unx75          ,_unx75          ,_unx75          ,_unx75          ,_unx75          ), 0, 0xffffffff, 0x00000000, 0          ) //
/* 76 */Y(0,0x20, Z(_ixBAERR_2      ,_ixBAERR_2      ,_ixBAERR_2      ,_ixBAERR_2      ,_ixBAERR_2      ,_ixBAERR_2      ,_ic0Fetchu      ,_ic1Fetchu      ,_ic2Fetchu      ,_ic0Fetchu      ,_ic1Fetchu      ,_ic2Fetchu      ), 0, 0xffffffff, 0x00000000, 0          ) // // Paired due to use with RVC
/* 77 */Y(0,0x20, Z(_ixBAERR_3      ,_ixBAERR_3      ,_ixBAERR_3      ,_ixBAERR_3      ,_ixBAERR_3      ,_ixBAERR_3      ,_ic0eFetchu     ,_ic1eFetchu     ,_ic2eFetchu     ,_ic0eFetchu     ,_ic1eFetchu     ,_ic2eFetchu     ), 0, 0xffffffff, 0x00000000, 0          ) // // Paired due to use with RVC
/* 78 */Y(0,0x22, Z(_unx78          ,_unx78          ,_unx78          ,_DIV_4          ,_DIV_4          ,_DIV_4          ,_unx78          ,_unx78          ,_unx78          ,_DIV_4          ,_DIV_4          ,_DIV_4          ), 2, 0x00400000, 0x00000000, 0          ) // illegal as entry. Can get here from OpCode close to "BEQ"
/* 79 */Y(0,0x22, Z(_unx79          ,_unx79          ,_unx79          ,_DIV_5          ,_DIV_5          ,_DIV_5          ,_unx79          ,_unx79          ,_unx79          ,_DIV_5          ,_DIV_5          ,_DIV_5          ), 2, 0x00400000, 0x00000000, 0          ) // illegal as entry. Can get here from OpCode close to "JALR"
...
/* 82 */Y(0,0x24, Z(_unx82          ,_unx82          ,_unx82          ,_DIV_1          ,_DIV_1          ,_DIV_1          ,_unx82          ,_unx82          ,_unx82          ,_DIV_1          ,_DIV_1          ,_DIV_1          ), 2, 0x00400000, 0x00000000, 0          ) // illegal as entry. Can get here from OpCode close to "ij"
/* 83 */Y(0,0x24, Z(_unx83          ,_unx83          ,_unx83          ,_DIV_2          ,_DIV_2          ,_DIV_2          ,_unx83          ,_unx83          ,_unx83          ,_DIV_2          ,_DIV_2          ,_DIV_2          ), 2, 0x00400000, 0x00000000, 0          ) // illegal as entry. Can get here from OpCode close to FENCE
/* 84 */Y(1,   0, _XORI_0                                                                                                                                                                                                       , 1, 0x0000707f, 0x00004013, (1<<22)    ) // XORI
/* 85 */Y(0,   0, _LBU_1                                                                                                                                                                                                        , 0, 0xffffffff, 0x00000000, 0          ) //
/* 86 */Y(0,0x26, Z(_x_JAL_2        ,_x_JAL_2        ,_x_JAL_2        ,_x_JAL_2        ,_x_JAL_2        ,_x_JAL_2        ,_r_JAL_2        ,_r_JAL_2        ,_r_JAL_2        ,_r_JAL_2        ,_r_JAL_2        ,_r_JAL_2        ), 0, 0xffffffff, 0x00000000, 0          ) //
/* 87 */Y(0,0x26, Z(_x_JALRE1       ,_x_JALRE1       ,_x_JALRE1       ,_x_JALRE1       ,_x_JALRE1       ,_x_JALRE1       ,_unx87          ,_unx87          ,_unx87          ,_unx87          ,_unx87          ,_unx87          ), 0, 0xffffffff, 0x00000000, 0          ) // 
/* 88 */Y(0,0x28, Z(_unx88          ,_unx88          ,_unx88          ,_DIV_E          ,_DIV_E          ,_DIV_E          ,_unx88          ,_unx88          ,_unx88          ,_DIV_E          ,_DIV_E          ,_DIV_E          ), 2, 0x00200000, 0x00000000, 0          ) // illegal as entry. Can get here from OpCode close to "SW"
/* 89 */Y(0,0x28, Z(_unx89          ,_unx89          ,_unx89          ,_DIV_F          ,_DIV_F          ,_DIV_F          ,_unx89          ,_unx89          ,_unx89          ,_DIV_F          ,_DIV_F          ,_DIV_F          ), 0, 0xffffffff, 0x00000000, 0          ) //                                                         
/* 8a */Y(0,0x2a, Z(_unx8a          ,_unx8a          ,_unx8a          ,_DIVU_5         ,_DIVU_5         ,_DIVU_5         ,_unx8a          ,_unx8a          ,_unx8a          ,_DIVU_5         ,_DIVU_5         ,_DIVU_5         ), 2, 0x00400000, 0x00000000, 0          ) // illegal as entry. Can get here from OpCode close to "SW" 
/* 8b */Y(0,0x2a, Z(_LB_6x          ,_LB_6x          ,_LB_6x          ,_LB_6m          ,_LB_6m          ,_LB_6m          ,_LB_6x          ,_LB_6x          ,_LB_6x          ,_LB_6m          ,_LB_6m          ,_LB_6m          ), 0, 0x00400000, 0x00000000, 0          ) //
...
/* 96 */Y(0,0x2c, _SH_1                                                                                                                                                                                                         , 0, 0xffffffff, 0x00000000, 0          ) //
/* 97 */Y(0,0x2c, _SW_E1SWH                                                                                                                                                                                                     , 0, 0xffffffff, 0x00000000, 0          ) //
...
/* 9b */Y(0,   0, Z(_x_condb_2      ,_x_condb_2      ,_x_condb_2      ,_x_condb_2      ,_x_condb_2      ,_x_condb_2      ,_r_condb_2      ,_r_condb_2      ,_r_condb_2      ,_r_condb_2      ,_r_condb_2      ,_r_condb_2      ), 0, 0xffffffff, 0x00000000, 0          ) //                         
/* 9c */Y(0,0x2e, Z(_unx9c          ,_unx9c          ,_unx9c          ,_DIV_10         ,_DIV_10         ,_DIV_10         ,_unx9c          ,_unx9c          ,_unx9c          ,_DIV_10         ,_DIV_10         ,_DIV_10         ), 2, 0x00001000, 0x00000000, 0          ) // illegal as entry. Can get here from OpCode close to "EBREAK/ECALL/CSR"
/* 9d */Y(0,0x2e, Z(_unx9d          ,_unx9d          ,_unx9d          ,_DIV_11         ,_DIV_11         ,_DIV_11         ,_unx9d          ,_unx9d          ,_unx9d          ,_DIV_11         ,_DIV_11         ,_DIV_11         ), 0, 0xffffffff, 0x00000000, 0          ) //                                                                       
...
/* a2 */Y(0,0x30, Z(_unxa2          ,_unxa2          ,_unxa2          ,_DIV_14         ,_DIV_14         ,_DIV_14         ,_unxa2          ,_unxa2          ,_unxa2          ,_DIV_14         ,_DIV_14         ,_DIV_14         ), 2, 0x00400000, 0x00000000, 0          ) // illegal as entry. Can get here from OpCode close to "ij"
/* a3 */Y(0,0x30, Z(_unxa3          ,_unxa3          ,_unxa3          ,_DIV_15         ,_DIV_15         ,_DIV_15         ,_unxa3          ,_unxa3          ,_unxa3          ,_DIV_15         ,_DIV_15         ,_DIV_15         ), 0, 0xffffffff, 0x00000000, 0          ) // illegal as entry. Can get here from OpCode close to FENCE
/* a4 */Y(1,   0, _SRxI_0                                                                                                                                                                                                       , 1, 0xbe00707f, 0x00005013, (1<<15)*2  ) // SRLI/SRAI
/* a5 */Y(0,   0, _MRET_3                                                                                                                                                                                                       , 0, 0xffffffff, 0x00000000, 0          ) //
/* a6 */Y(0,0x32, _ECAL_RET                                                                                                                                                                                                     , 0, 0xffffffff, 0x00000000, 0          ) //
/* a7 */Y(0,0x32, _EBRKWFI1                                                                                                                                                                                                     , 0, 0xffffffff, 0x00000000, 0          ) //
...
/* b2 */Y(0,   0, _CSRRW_4                                                                                                                                                                                                      , 0, 0xffffffff, 0x00000000, 0          ) //
...
/* be */Y(0,0x34, Z(_x_IJ_1         ,_x_IJ_1         ,_x_IJ_1         ,_x_IJ_1         ,_x_IJ_1         ,_x_IJ_1         ,_r_IJ_1         ,_r_IJ_1         ,_r_IJ_1         ,_r_IJ_1         ,_r_IJ_1         ,_r_IJ_1         ), 0, 0xffffffff, 0x00000000, 0          ) //
/* bf */Y(0,0x34, Z(_x_IJT_1        ,_x_IJT_1        ,_x_IJT_1        ,_x_IJT_1        ,_x_IJT_1        ,_x_IJT_1        ,_r_IJT_1        ,_r_IJT_1        ,_r_IJT_1        ,_r_IJT_1        ,_r_IJT_1        ,_r_IJT_1        ), 0, 0xffffffff, 0x00000000, 0          ) //
...
/* c2 */Y(0,0x36, Z(_unxc2          ,_unxc2          ,_unxc2          ,_DIVU_3         ,_DIVU_3         ,_DIVU_3         ,_unxc2          ,_unxc2          ,_unxc2          ,_DIVU_3         ,_DIVU_3         ,_DIVU_3         ), 2, 0x00400000, 0x00000000, 0          ) // Illegal as entry. Can get here from OpCode close to "ij"
/* c3 */Y(0,0x36, Z(_unxc3          ,_unxc3          ,_unxc3          ,_DIVU_4         ,_DIVU_4         ,_DIVU_4         ,_unxc3          ,_unxc3          ,_unxc3          ,_DIVU_4         ,_DIVU_4         ,_DIVU_4         ), 2, 0x00400000, 0x00000000, 0          ) // illegal as entry. Can get here from OpCode close to FENCE. 
...
/* d0 */Y(0,0x38, _ECALL_1                                                                                                                                                                                                      , 0, 0xffffffff, 0x00000000, 0          ) //
/* d1 */Y(0,0x38, _MRET_1                                                                                                                                                                                                       , 0, 0xffffffff, 0x00000000, 0          ) //
/* d2 */Y(0,0x3a, _LB_2                                                                                                                                                                                                         , 0, 0xffffffff, 0x00000000, 0          ) //
/* d3 */Y(0,0x3a, _aFaultd                                                                                                                                                                                                      , 0, 0xffffffff, 0x00000000, 0          ) //
...
/* d6 */Y(0,0x3c, _eILL0c                                                                                                                                                                                                       , 0, 0xffffffff, 0x00000000, 0          ) //
/* d7 */Y(0,0x3c, _ECALL_3                                                                                                                                                                                                      , 0, 0xffffffff, 0x00000000, 0          ) //
...
/* de */Y(0,0x3e, Z(_i0Fetch        ,_i1Fetch        ,_i2Fetch        ,_i0Fetch        ,_i1Fetch        ,_i2Fetch        ,_ic0Fetch       ,_ic1Fetch       ,_ic2Fetch       ,_ic0Fetch       ,_ic1Fetch       ,_ic2Fetch       ), 0, 0xffffffff, 0x00000000, 0          ) //
/* df */Y(0,0x3e, Z(_i0eFetch       ,_i1eFetch       ,_i2eFetch       ,_i0eFetch       ,_i1eFetch       ,_i2eFetch       ,_ic0eFetch      ,_ic1eFetch      ,_ic2eFetch      ,_ic0eFetch      ,_ic1eFetch      ,_ic2eFetch      ), 0, 0xffffffff, 0x00000000, 0          ) //
...
/* e2 */Y(0,0x40, Z(_unxe2          ,_unxe2          ,_unxe2          ,_MUL_1          ,_MUL_1          ,_MUL_1          ,_unxe2          ,_unxe2          ,_unxe2          ,_MUL_1          ,_MUL_1          ,_MUL_1          ), 2, 0x00400000, 0x00000000, 0          ) // illegal as entry. Can get here from OpCode close to "ij"
/* e3 */Y(0,0x40, Z(_unxe3          ,_unxe3          ,_unxe3          ,_MUL_3          ,_MUL_3          ,_MUL_3          ,_unxe3          ,_unxe3          ,_unxe3          ,_MUL_3          ,_MUL_3          ,_MUL_3          ), 2, 0x00400000, 0x00000000, 0          ) // illegal as entry. Can get here from OpCode close to FENCE
/* e4 */Y(1,   0, _ANDI_0                                                                                                                                                                                                       , 1, 0x0000707f, 0x00007013, (1<<22)    ) // ANDI
/* e5 */Y(0,   0, _aF_SW_2                                                                                                                                                                                                      , 0, 0xffffffff, 0x00000000, 0          ) //
/* e6 */Y(0,0x42, Z(_i0StdIncPc     ,_i1StdIncPc     ,_i2StdIncPc     ,_i0StdIncPc     ,_i1StdIncPc     ,_i2StdIncPc     ,_ic0StdIncPc    ,_ic1StdIncPc    ,_ic2StdIncPc    ,_ic0StdIncPc    ,_ic1StdIncPc    ,_ic2StdIncPc    ), 0, 0xffffffff, 0x00000000, 0          ) //
/* e7 */Y(0,0x42, _aFault                                                                                                                                                                                                       , 0, 0xffffffff, 0x00000000, 0          ) //
...
/* ee */Y(0,0x44, _eILL0a                                                                                                                                                                                                       , 0, 0xffffffff, 0x00000000, 0          ) // Reached with LAZY_DECODE==1
/* ef */Y(0,0x44, _WFI_5                                                                                                                                                                                                        , 0, 0xffffffff, 0x00000000, 0          ) // Reached with LAZY_DECODE==1
/* f0 */Y(0,0x46, _LBU_2                                                                                                                                                                                                        , 0, 0xffffffff, 0x00000000, 0          ) //
/* f1 */Y(0,0x46, _aFaulte                                                                                                                                                                                                      , 0, 0xffffffff, 0x00000000, 0          ) //
/* f2 */Y(0,0x48, _SW_2                                                                                                                                                                                                         , 0, 0xffffffff, 0x00000000, 0          ) //
/* f3 */Y(0,0x48, _aF_SW                                                                                                                                                                                                        , 0, 0xffffffff, 0x00000000, 0          ) //
/* f4 */Y(0,0x4a, Z(_i0Fetch2       ,_i1Fetch2       ,_i2Fetch2       ,_i0Fetch2       ,_i1Fetch2       ,_i2Fetch2       ,_ic0Fetch2      ,_ic1Fetch2      ,_ic2Fetch2      ,_ic0Fetch2      ,_ic1Fetch2      ,_ic2Fetch2      ), 0, 0xffffffff, 0x00000000, 0          ) //
/* f5 */Y(0,0x4a, _jFault                                                                                                                                                                                                       , 0, 0xffffffff, 0x00000000, 0          ) //
/* f6 */Y(0,0x4c, _WFI_1                                                                                                                                                                                                        , 0, 0xffffffff, 0x00000000, 0          ) //
/* f7 */Y(0,0x4c, _EBREAK_1                                                                                                                                                                                                     , 0, 0xffffffff, 0x00000000, 0          ) //
