...
/* This macro is used as a tag to insert support code for midgetv
   ...
   We initiate the stack pointer to top of EBR, and that is it.
*/

#define STACK_INITPOS 0x1000
...
*/        
        ...
        .section .magicconstants, "awx",@progbits

//__mepc:         .word 0xbebaadde  // 0xb4
//__mcause:       .word 0           // 0xb8
//__mtval:        .word 0           // 0xbc
//__mscratch:     .word 0           // 0xc0
//__misa:         .word 0x40800104  // 0xc4
#define x_ex_dup_x0  0xc8
#define x_ex_rCSRadr 0xcc 
#define x_ex_rCSRty  0xd0 
#define x_ex_rrs1    0xd4
#define x_ex_rrd     0xd8
#define x_ex_rtmp    0xdc
//_mtime:         .word 0           // 0xe0
//_mtimeh:        .word 0           // 0xe4
//__freefornow_e8:.word 0           // 0xe8
//__minstreth:    .word 0           // 0xec
//__mcycleh:      .word 0           // 0xf0
//__freefornow_f4:.word 0           // 0xf4
//__mtimecmp:     .word 0xffffffff  // 0xf8
//__mtimecmph:    .word 0xffffffff  // 0xfc
CSRretadr:      .word 0           //
...
dbgtag2:addi    rrd,rrd,x_ex_dup_x0
...
1:        
        ...
        addi    rrs1,rrs1,x_ex_dup_x0        
        sw      x0,x_ex_dup_x0(x0)      // A previous CSR instruction may have used _ex_dup_x0
...
RestoreWorkingRegisters:        
        lw      rrd, x_ex_rrd(x0)
        lw      rrs1,x_ex_rrs1(x0)          
        lw      rCSRadr,x_ex_rCSRadr(x0)    
        lw      rCSRty,x_ex_rCSRty(x0)      
        bnez    rtmp,1f                         
        lw      rtmp,x_ex_rtmp(x0)          
        ij      0,0x101,0                       // Exit, but will enter trap.
1:      lw      rtmp,x_ex_rtmp(x0)         
