 ...
 * -----------------------------------------------------------------------------
 * Cycle-true simulation of midgetv. 128 KiB SRAM, 8 KiB EBR
 */
#include <stdio.h>
#include <stdlib.h>
#include <stdint.h>
 ...
 * These macros __must__ correspond to parameters in m_ice40sim_SRAM4_EBR16.v
 */
#define SRAM_ADRLINES 17
#define EBRADRWIDTH   11 
...
/////////////////////////////////////////////////////////////////////////////
#include "Vm_ice40sim_SRAM4_EBR16__Syms.h"
...
uint32_t getebr( Vm_ice40sim_SRAM4_EBR16 *tb, uint32_t byteadr ) {
        uint32_t d;
...
#elif EBRADRWIDTH == 9
        d =  (tb->v->inst_ice40sim_EBRonly->inst_midgetv_core->inst_ebr->b0__BRA__0__KET____DOT__ebr->get_as_8(wa) <<  0);
        d |= (tb->v->inst_ice40sim_EBRonly->inst_midgetv_core->inst_ebr->b0__BRA__1__KET____DOT__ebr->get_as_8(wa) <<  8);
        d |= (tb->v->inst_ice40sim_EBRonly->inst_midgetv_core->inst_ebr->b0__BRA__2__KET____DOT__ebr->get_as_8(wa) << 16);
        d |= (tb->v->inst_ice40sim_EBRonly->inst_midgetv_core->inst_ebr->b0__BRA__3__KET____DOT__ebr->get_as_8(wa) << 24);
#elif EBRADRWIDTH == 10
        d =  (tb->v->inst_ice40sim_EBRonly->inst_midgetv_core->inst_ebr->b0__BRA__0__KET____DOT__ebr->get_as_4(wa) <<  0);
        d |= (tb->v->inst_ice40sim_EBRonly->inst_midgetv_core->inst_ebr->b0__BRA__1__KET____DOT__ebr->get_as_4(wa) <<  4);
        d |= (tb->v->inst_ice40sim_EBRonly->inst_midgetv_core->inst_ebr->b0__BRA__2__KET____DOT__ebr->get_as_4(wa) <<  8);
        d |= (tb->v->inst_ice40sim_EBRonly->inst_midgetv_core->inst_ebr->b0__BRA__3__KET____DOT__ebr->get_as_4(wa) << 12);
        d |= (tb->v->inst_ice40sim_EBRonly->inst_midgetv_core->inst_ebr->b0__BRA__4__KET____DOT__ebr->get_as_4(wa) << 16);
        d |= (tb->v->inst_ice40sim_EBRonly->inst_midgetv_core->inst_ebr->b0__BRA__5__KET____DOT__ebr->get_as_4(wa) << 20);
        d |= (tb->v->inst_ice40sim_EBRonly->inst_midgetv_core->inst_ebr->b0__BRA__6__KET____DOT__ebr->get_as_4(wa) << 24);
        d |= (tb->v->inst_ice40sim_EBRonly->inst_midgetv_core->inst_ebr->b0__BRA__7__KET____DOT__ebr->get_as_4(wa) << 28);
#elif EBRADRWIDTH == 11 
        d =  (tb->v->inst_ice40sim_EBRonly->inst_midgetv_core->inst_ebr->b0__BRA__0__KET____DOT__ebr->get_as_2(wa)  <<  0);
        d |= (tb->v->inst_ice40sim_EBRonly->inst_midgetv_core->inst_ebr->b0__BRA__1__KET____DOT__ebr->get_as_2(wa)  <<  2);
        d |= (tb->v->inst_ice40sim_EBRonly->inst_midgetv_core->inst_ebr->b0__BRA__2__KET____DOT__ebr->get_as_2(wa)  <<  4);
        d |= (tb->v->inst_ice40sim_EBRonly->inst_midgetv_core->inst_ebr->b0__BRA__3__KET____DOT__ebr->get_as_2(wa)  <<  6);
        d |= (tb->v->inst_ice40sim_EBRonly->inst_midgetv_core->inst_ebr->b0__BRA__4__KET____DOT__ebr->get_as_2(wa)  <<  8);
        d |= (tb->v->inst_ice40sim_EBRonly->inst_midgetv_core->inst_ebr->b0__BRA__5__KET____DOT__ebr->get_as_2(wa)  << 10);
        d |= (tb->v->inst_ice40sim_EBRonly->inst_midgetv_core->inst_ebr->b0__BRA__6__KET____DOT__ebr->get_as_2(wa)  << 12);
        d |= (tb->v->inst_ice40sim_EBRonly->inst_midgetv_core->inst_ebr->b0__BRA__7__KET____DOT__ebr->get_as_2(wa)  << 14);
        d |= (tb->v->inst_ice40sim_EBRonly->inst_midgetv_core->inst_ebr->b0__BRA__8__KET____DOT__ebr->get_as_2(wa)  << 16);
        d |= (tb->v->inst_ice40sim_EBRonly->inst_midgetv_core->inst_ebr->b0__BRA__9__KET____DOT__ebr->get_as_2(wa)  << 18);
        d |= (tb->v->inst_ice40sim_EBRonly->inst_midgetv_core->inst_ebr->b0__BRA__10__KET____DOT__ebr->get_as_2(wa) << 20);
        d |= (tb->v->inst_ice40sim_EBRonly->inst_midgetv_core->inst_ebr->b0__BRA__11__KET____DOT__ebr->get_as_2(wa) << 22);
        d |= (tb->v->inst_ice40sim_EBRonly->inst_midgetv_core->inst_ebr->b0__BRA__12__KET____DOT__ebr->get_as_2(wa) << 24);
        d |= (tb->v->inst_ice40sim_EBRonly->inst_midgetv_core->inst_ebr->b0__BRA__13__KET____DOT__ebr->get_as_2(wa) << 26);
        d |= (tb->v->inst_ice40sim_EBRonly->inst_midgetv_core->inst_ebr->b0__BRA__14__KET____DOT__ebr->get_as_2(wa) << 28);
        d |= (tb->v->inst_ice40sim_EBRonly->inst_midgetv_core->inst_ebr->b0__BRA__15__KET____DOT__ebr->get_as_2(wa) << 30);
#else
...
uint32_t getsram( void *vtb, uint32_t byteadr ) {
        ...
        byteadr &= 0xFFFF; 
        uint32_t wa = byteadr/4;
        Vm_ice40sim_SRAM4_EBR16 *tb =(Vm_ice40sim_SRAM4_EBR16 *)vtb;
 ...
 */
void readout_ebr_sram(const char *hdrEBR, const char *hdrSRAM, int hexdumpit, Vm_ice40sim_SRAM4_EBR16 *tb ) {
        int i;
        uint32_t d;
...
/////////////////////////////////////////////////////////////////////////////
void readout_ebr(const char *hdrEBR, int hexdumpit, Vm_ice40sim_SRAM4_EBR16 *tb ) {
        int i;
        uint32_t d;
...
/////////////////////////////////////////////////////////////////////////////
void initialize_ebr_sram( Vm_ice40sim_SRAM4_EBR16 *tb, FILE *fi, char *finame ) {
        int i,j,c;
...
#elif EBRADRWIDTH == 9
        for ( j = 0; j < i; j += 4 ) {
                tb->v->inst_ice40sim_EBRonly->inst_midgetv_core->inst_ebr->b0__BRA__0__KET____DOT__ebr->set_as_8(j>>2,ebr[j+0]);
                tb->v->inst_ice40sim_EBRonly->inst_midgetv_core->inst_ebr->b0__BRA__1__KET____DOT__ebr->set_as_8(j>>2,ebr[j+1]);
                tb->v->inst_ice40sim_EBRonly->inst_midgetv_core->inst_ebr->b0__BRA__2__KET____DOT__ebr->set_as_8(j>>2,ebr[j+2]);
                tb->v->inst_ice40sim_EBRonly->inst_midgetv_core->inst_ebr->b0__BRA__3__KET____DOT__ebr->set_as_8(j>>2,ebr[j+3]);
        }
#elif EBRADRWIDTH == 10
        for ( j = 0; j < i; j += 4 ) {
                tb->v->inst_ice40sim_EBRonly->inst_midgetv_core->inst_ebr->b0__BRA__0__KET____DOT__ebr->set_as_4(j>>2,(ebr[j+0] >> 0) & 15);
                tb->v->inst_ice40sim_EBRonly->inst_midgetv_core->inst_ebr->b0__BRA__1__KET____DOT__ebr->set_as_4(j>>2,(ebr[j+0] >> 4) & 15);
                tb->v->inst_ice40sim_EBRonly->inst_midgetv_core->inst_ebr->b0__BRA__2__KET____DOT__ebr->set_as_4(j>>2,(ebr[j+1] >> 0) & 15);
                tb->v->inst_ice40sim_EBRonly->inst_midgetv_core->inst_ebr->b0__BRA__3__KET____DOT__ebr->set_as_4(j>>2,(ebr[j+1] >> 4) & 15);
                tb->v->inst_ice40sim_EBRonly->inst_midgetv_core->inst_ebr->b0__BRA__4__KET____DOT__ebr->set_as_4(j>>2,(ebr[j+2] >> 0) & 15);
                tb->v->inst_ice40sim_EBRonly->inst_midgetv_core->inst_ebr->b0__BRA__5__KET____DOT__ebr->set_as_4(j>>2,(ebr[j+2] >> 4) & 15);
                tb->v->inst_ice40sim_EBRonly->inst_midgetv_core->inst_ebr->b0__BRA__6__KET____DOT__ebr->set_as_4(j>>2,(ebr[j+3] >> 0) & 15);
                tb->v->inst_ice40sim_EBRonly->inst_midgetv_core->inst_ebr->b0__BRA__7__KET____DOT__ebr->set_as_4(j>>2,(ebr[j+3] >> 4) & 15);
        }
#elif EBRADRWIDTH == 11
        for ( j = 0; j < i; j += 4 ) {
                tb->v->inst_ice40sim_EBRonly->inst_midgetv_core->inst_ebr->b0__BRA__0__KET____DOT__ebr->set_as_2( j>>2,(ebr[j+0] >> 0) & 3);
                tb->v->inst_ice40sim_EBRonly->inst_midgetv_core->inst_ebr->b0__BRA__1__KET____DOT__ebr->set_as_2( j>>2,(ebr[j+0] >> 2) & 3);
                tb->v->inst_ice40sim_EBRonly->inst_midgetv_core->inst_ebr->b0__BRA__2__KET____DOT__ebr->set_as_2( j>>2,(ebr[j+0] >> 4) & 3);
                tb->v->inst_ice40sim_EBRonly->inst_midgetv_core->inst_ebr->b0__BRA__3__KET____DOT__ebr->set_as_2( j>>2,(ebr[j+0] >> 6) & 3);
                tb->v->inst_ice40sim_EBRonly->inst_midgetv_core->inst_ebr->b0__BRA__4__KET____DOT__ebr->set_as_2( j>>2,(ebr[j+1] >> 0) & 3);
                tb->v->inst_ice40sim_EBRonly->inst_midgetv_core->inst_ebr->b0__BRA__5__KET____DOT__ebr->set_as_2( j>>2,(ebr[j+1] >> 2) & 3);
                tb->v->inst_ice40sim_EBRonly->inst_midgetv_core->inst_ebr->b0__BRA__6__KET____DOT__ebr->set_as_2( j>>2,(ebr[j+1] >> 4) & 3);
                tb->v->inst_ice40sim_EBRonly->inst_midgetv_core->inst_ebr->b0__BRA__7__KET____DOT__ebr->set_as_2( j>>2,(ebr[j+1] >> 6) & 3);
                tb->v->inst_ice40sim_EBRonly->inst_midgetv_core->inst_ebr->b0__BRA__8__KET____DOT__ebr->set_as_2( j>>2,(ebr[j+2] >> 0) & 3);
                tb->v->inst_ice40sim_EBRonly->inst_midgetv_core->inst_ebr->b0__BRA__9__KET____DOT__ebr->set_as_2( j>>2,(ebr[j+2] >> 2) & 3);
                tb->v->inst_ice40sim_EBRonly->inst_midgetv_core->inst_ebr->b0__BRA__10__KET____DOT__ebr->set_as_2(j>>2,(ebr[j+2] >> 4) & 3);
                tb->v->inst_ice40sim_EBRonly->inst_midgetv_core->inst_ebr->b0__BRA__11__KET____DOT__ebr->set_as_2(j>>2,(ebr[j+2] >> 6) & 3);
                tb->v->inst_ice40sim_EBRonly->inst_midgetv_core->inst_ebr->b0__BRA__12__KET____DOT__ebr->set_as_2(j>>2,(ebr[j+3] >> 0) & 3);
                tb->v->inst_ice40sim_EBRonly->inst_midgetv_core->inst_ebr->b0__BRA__13__KET____DOT__ebr->set_as_2(j>>2,(ebr[j+3] >> 2) & 3);
                tb->v->inst_ice40sim_EBRonly->inst_midgetv_core->inst_ebr->b0__BRA__14__KET____DOT__ebr->set_as_2(j>>2,(ebr[j+3] >> 4) & 3);
                tb->v->inst_ice40sim_EBRonly->inst_midgetv_core->inst_ebr->b0__BRA__15__KET____DOT__ebr->set_as_2(j>>2,(ebr[j+3] >> 6) & 3);
        }
#else
#error Unsupported EBR address width
#endif
...
int check_for_simulationhint( FILE *lfo, char *imagetosimnamep, Vm_ice40sim_SRAM4_EBR16 *tb, int silent) {
...
/////////////////////////////////////////////////////////////////////////////
void simprintf( uint32_t cy, Vm_ice40sim_SRAM4_EBR16 *tb ) {
        if ( g_suspendtrace )
                return;
...
int main(int argc, char **argv) {
	...
	Vm_ice40sim_SRAM4_EBR16 *tb = new Vm_ice40sim_SRAM4_EBR16;
	...
	// Initialize Verilators variables
        ...
        readout_ebr( "After custom init with program to simulate. EBR\n", 1, tb );
        exit(0);
